...
-- Insertar 5 Usuarios
-- La contraseña para todos los usuarios de ejemplo es "password123"
-- El hash fue generado con Argon2
INSERT INTO usuario (nombre, correo, hashed_password, fecha_registro) VALUES
('María García', 'maria.garcia@email.com', '$argon2id$v=19$m=65536,t=3,p=4$Y2FjaGVzZWNyZXQ$a9k/wz3i8z7k6J2O3p2l3Q', datetime('now')),
('Juan Pérez', 'juan.perez@email.com', '$argon2id$v=19$m=65536,t=3,p=4$Y2FjaGVzZWNyZXQ$a9k/wz3i8z7k6J2O3p2l3Q', datetime('now')),
('Ana Martínez', 'ana.martinez@email.com', '$argon2id$v=19$m=65536,t=3,p=4$Y2FjaGVzZWNyZXQ$a9k/wz3i8z7k6J2O3p2l3Q', datetime('now')),
('Carlos Rodríguez', 'carlos.rodriguez@email.com', '$argon2id$v=19$m=65536,t=3,p=4$Y2FjaGVzZWNyZXQ$a9k/wz3i8z7k6J2O3p2l3Q', datetime('now')),
('Laura Fernández', 'laura.fernandez@email.com', '$argon2id$v=19$m=65536,t=3,p=4$Y2FjaGVzZWNyZXQ$a9k/wz3i8z7k6J2O3p2l3Q', datetime('now'));
